...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'online party game', 'free party game', 'truth or dare', 'never have i ever', 'most likely to',
    'drinking games app', 'get drunk game', 'icebreaker game', 'bonding game', 'wingman game',
  ],
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.jpg', width: 1200, height: 630, alt: 'Tipsy Trials Game Banner' }],
    locale: 'en_US',
    type: 'website',
  },
  twitter: {
