...
export default function AddWastedPromptModal({ isOpen, onClose, onSuccess, existingPrompt }: Props) {
    ...
    const handleSave = async () => {
        ...
        if (existingPrompt) {
            ...
            const { error: insertError } = await supabase.from('wasted_prompts').insert([
                {
                    text: text.trim(),
                    dirty,
                    like_count: 0,
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="p-8">
                ...
                <textarea
                    ...
                    placeholder='e.g. Pick someone - you both take a sip together. Cheers!'
                    rows={3}
